...
AUTHENTICATION_BACKENDS = [
    'auth.backends.CampaNationalAuthBackend',
...
# Added Media configuration to serve uploaded images (e.g. Uploads/NUR/...)
MEDIA_URL = '/media/'
MEDIA_ROOT = BASE_DIR
...
RECAPTCHA_SECRET_KEY = os.getenv('RECAPTCHA_SECRET_KEY', '6LfCIHUtAAAAANqXloxdFytoKShd0M0OFr_YEXaO')